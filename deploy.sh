...
gcloud run deploy "$SERVICE_NAME" \
  ...
  --min-instances=0 \
  --max-instances=3 \
  --set-env-vars="^##^GOOGLE_CLOUD_PROJECT=$PROJECT_ID##GCS_BUCKET=wardrub-assets-1##ALLOWED_ORIGINS=$ALLOWED_ORIGIN##VERTEX_AI_LOCATION=us-central1##GEMINI_API_KEY=AIzaSyDPD1rwAPORD54bOW6u068WbzBoj7hhjps##GEMINI_MODEL_TYPE=pro##OPENWEATHER_API_KEY=b6269b61808f6937854e57cf13df6967##REPLICATE_API_TOKEN=r8_XFI00pbliTGwzmGcT4XRVGxvv9QYDDS4IXrb9"
